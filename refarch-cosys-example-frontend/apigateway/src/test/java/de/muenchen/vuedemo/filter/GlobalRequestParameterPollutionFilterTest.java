 ...
 */
package de.muenchen.vuedemo.filter;

import de.muenchen.vuedemo.ApiGatewayApplication;
...
import static de.muenchen.vuedemo.TestConstants.SPRING_TEST_PROFILE;
...
public class GlobalRequestParameterPollutionFilterTest {
    ...
    public void parameterPollutionAttack() {
        ...
        webTestClient.get().uri("/api/vuedemo-backend-service/testendpoint?parameter1=testdata_1&parameter2=testdata&parameter1=testdata_2").exchange()
                .expectStatus()
