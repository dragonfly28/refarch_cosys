 ...
 */
package de.muenchen.vuedemo.configuration;

import de.muenchen.vuedemo.filter.CsrfTokenAppendingHelperFilter;
import de.muenchen.vuedemo.util.GatewayUtils;
        ...
        http
                ...
                .and()
                    .authorizeExchange()
                        ...
                        .pathMatchers("/api/*/actuator/info", "/actuator/health", "/info").permitAll()
                        // only authenticated
