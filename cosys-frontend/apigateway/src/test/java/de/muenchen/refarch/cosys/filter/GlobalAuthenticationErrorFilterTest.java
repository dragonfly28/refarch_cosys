 ...
 */
package de.muenchen.refarch.cosys.filter;

import com.github.tomakehurst.wiremock.http.HttpHeader;
import com.github.tomakehurst.wiremock.http.HttpHeaders;
import com.github.tomakehurst.wiremock.junit.WireMockClassRule;
import de.muenchen.refarch.cosys.ApiGatewayApplication;
...
import static de.muenchen.refarch.cosys.TestConstants.WIREMOCK_PORT_NUMBER;
...
public class GlobalAuthenticationErrorFilterTest {
    ...
    public void backendAuthenticationError() {
        webTestClient.get().uri("/api/cosys_prototype-backend-service/remote").exchange()
