...
@PreAuthorize("hasAuthority(T(de.muenchen.refarch.cosys.security.AuthoritiesEnum).COSYS_BACKEND_READ_THEENTITY.name())")
public interface TheEntityRepository extends PagingAndSortingRepository<TheEntity, UUID> { //NOSONAR
    ...
    @PreAuthorize("hasAuthority(T(de.muenchen.refarch.cosys.security.AuthoritiesEnum).COSYS_BACKEND_WRITE_THEENTITY.name())")
    ...
    @PreAuthorize("hasAuthority(T(de.muenchen.refarch.cosys.security.AuthoritiesEnum).COSYS_BACKEND_DELETE_THEENTITY.name())")
